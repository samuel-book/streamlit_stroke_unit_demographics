...
cols_prettier_dict = {
    ...
    'weighted_ivt_time': 'Time to IVT unit (weighted by number of people aged 65+)',
    'mt_time_weighted_mean': 'Time to MT unit (weighted by population)',
    'ivt_time_weighted_mean': 'Time to IVT unit (weighted by population)',
    'mt_transfer_time_weighted_mean': 'Time to transfer unit (weighted by population)',
    ...
    'proportion_over_65_within_30': 'Proportion of people aged 65+ who live within 30mins of stroke unit',
